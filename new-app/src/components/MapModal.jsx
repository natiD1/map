...
const LuxuryMapModal = ({ show, onClose, initialCoords, searchedLocation, onMapAction, useVideoBackground = false }) => {
    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                className={`fixed inset-0 z-30 flex flex-col p-2 md:p-6 ${
                    useVideoBackground 
                        ? 'bg-transparent' 
            ...
            >
                ...
                {/* MODIFIED: Added relative and z-20 classes */}
                <div className="relative z-20 flex flex-col h-full w-full" onClick={(e) => e.stopPropagation()}>
                    <LuxuryMapHeader
                    ...
                    />
                   <div className={`flex flex-1 min-h-0 flex-col space-y-4 lg:space-y-0 ${isRtl ? 'lg:space-x-reverse lg:space-x-6' : 'lg:space-x-6'} ${selectedLocation ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}>
    {isSidebarOpen && (
        <motion.div
           ...
           variants={selectedLocation ? (isRtl ? animations.slideInRight : animations.slideInLeft) : (isRtl ? animations.slideInLeft : animations.slideInRight)} initial="initial" animate="animate"
        >
            <AnimatePresence mode="wait">
                 {activePanel === 'userActions' ? (
